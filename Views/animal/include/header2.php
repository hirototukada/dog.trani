...
<body>
  <nav class="green navbar navbar-light text-white mb-2 bg-opacity-50">
    ...
    <a class="navbar-brand"><img src="/img/logo (3).png" class = 'logo3' style="height:5rem" alt="ロゴ"></a>      <div class="nav-item dropdown">
