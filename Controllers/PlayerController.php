...
public function Fetch_question_user($id){
    $result = $this->dog_post->fetch_question_user($id);
    return $result;
}
 /**
   *postテーブル削除機能
 ...
 public function Post_question_Delete($brog){
     $result = $this->dog_post->post_question_Delete($brog);
     return $result;
 }
 /**
   *questionテーブルの決められたデータ取得
 ...
 public function Fetch_question(){
     $result = $this->dog_post->fetch_question();
     return $result;
 }
 /**
   *postテーブルにデータを追加
 ...
 public function Fetch_post_question(){
     $result = $this->dog_post->fetch_post_question();
     return $result;
 }     
 /**
   *postテーブル更新機能
 ...
 public function Question_Delete($brog){
    $result = $this->dog_post->question_Delete($brog);
    return $result;
 }
 /**
 ...
 public function Fetch_question_id($get){
     $result = $this->dog_post->fetch_question_id($get);
     return $result;
 }
 /**
      *questionテーブルにデータを追加
      ...
      */
      public function Insert_questions($brog){
        $result = $this->dog_post->insert_questions($brog);
        return $result;
    }   
}
